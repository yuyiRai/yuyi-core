...
export declare const objToForm: (model: IKeyValueMap<any>, store: FormStore<any, import("./FormStore/FormItemStoreBase").IFormItemStore<any, any>>, form: WrappedFormUtils<any>) => {};
