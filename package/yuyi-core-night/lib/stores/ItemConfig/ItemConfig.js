...
var ItemConfig = /** @class */ (function (_super) {
    ...
    function ItemConfig(initModel, form, componentProps, formStore) {
        ...
        _this.displayConfig = new DisplayConfig(_this, _this.formStore);
        _this.childrenConfig = {};
        _this.setFormStore(formStore);
        _this.autorun(function () {
            if (_this.formStore && _this.isComputedEnable && _this.computed !== _this.currentValue) {
    ...
    Object.defineProperty(ItemConfig, "commonTransformer", {
        get: function () {
            return createTransformer(this.commonTransformerConfig ||
                (function (_a) {
                    var type = _a.type, multiple = _a.multiple, filter = _a.filter, filterToValue = _a.filterToValue;
    ...
    __decorate([
        computed,
        __metadata("design:type", DisplayConfig),
    ...
    __decorate([
        ...
        __metadata("design:returntype", OptionsStore)
