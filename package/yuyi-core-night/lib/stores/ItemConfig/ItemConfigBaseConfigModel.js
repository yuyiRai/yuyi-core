...
import { createTransformer, createViewModel } from 'mobx-utils';
...
var ItemConfigBaseConfigModel = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ItemConfigBaseConfigModel.prototype, "currentValueFromStore", {
        get: function () {
    ...
    Object.defineProperty(ItemConfigBaseConfigModel.prototype, "formSource", {
        get: function () {
            ...
            return (this.formStore && this.formStore.formSource) || {};
        },
        enumerable: true,
        configurable: true
    });
    ...
    ItemConfigBaseConfigModel.prototype.getComputedValue = function (key, target, defaultValue) {
        ...
        try {
            ...
            if (!(/(^refConfig$)|^(on|get(.*?))|((.*?)Method)$|(.*?)filter(.*?)/.test(key)) && (keyValue instanceof Function)) {
                var computedValue = keyValue(this.formStore.formMap.toJSON(), this);
    ...
    __decorate([
        ...
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ], ItemConfigBaseConfigModel.prototype, "currentValueFromStore", null);
    __decorate([
        observable.ref,
