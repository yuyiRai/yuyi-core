...
export var YuyiContainer = styled.div.withConfig({ displayName: "YuyiContainer", componentId: "sc-1qq3fjf" })(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: fixed;\n  z-index: 2048;\n"], ["\n  position: fixed;\n  z-index: 2048;\n"])));
