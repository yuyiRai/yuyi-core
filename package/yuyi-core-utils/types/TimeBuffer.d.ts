...
export declare const BufferCacheGroup: {
...
export declare function logger<P extends any = any>(name?: string, time?: boolean): (target: any, methodName: string, descriptor: PropertyDescriptor) => void;
