...
var config = [
    ...
    { label: '单选', code: 'search', type: "search", allowInput: true, options: options, nameCode: 'searchName' },
    {
...
var store;
var getStore = function (gstore) {
    store = gstore;
};
storiesOf('DEMO', module)
    .addDecorator(function (story) { return React.createElement("div", { style: __$hoisted_o0 }, story()); })
    .addDecorator(withKnobs)
    .add('App', function () {
    var model = object('Model', props.model);
    var config = object('Config', props.config);
    return (React.createElement(CommonForm, { model: model, storeRef: getStore },
        React.createElement(FormGroup, { key: 0, config: config, disabled: true },
            React.createElement(Button, { type: "primary", icon: "search" }, text('Search', 'Search')),
            ...
            React.createElement(Button, { onClick: __$hoisted_o1 }, "\u8868\u5355\u91CD\u8F7D"))));
}, {
    info: {
        inline: false
    },
...
var __$hoisted_o0 = { padding: 30 };
var __$hoisted_o1 = function () {
    props.model = {};
};
