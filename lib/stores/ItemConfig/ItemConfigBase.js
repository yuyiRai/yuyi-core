...
var ItemConfig_1 = require("./interface/ItemConfig");
...
var ItemConfigBase = /** @class */ (function (_super) {
    ...
    function ItemConfigBase(initModel, form, componentProps) {
        ...
        _this.initConfig = mobx_1.observable.map({});
        _this.$version = 0;
        // @observable loading = false;
        _this.displayConfig = new ItemDisplayConfig_1.DisplayConfig();
        _this.onPropertyChange = new EventEmitter_1.EventEmitter();
    ...
    Object.defineProperty(ItemConfigBase.prototype, "displayProps", {
        get: function () {
    ...
    Object.defineProperty(ItemConfigBase.prototype, "isViewOnly", {
        get: function () {
    ...
    Object.defineProperty(ItemConfigBase.prototype, "otherKey", {
        get: function () {
            return lodash_1.difference(this.iKeys, lodash_1.keys(this), ['refConfig', 'code', 'rule', 'remoteMethod', 'loading', 'options', 'isViewOnly', 'transformer']);
        },
        enumerable: true,
        configurable: true
    });
    ...
    ItemConfigBase.prototype.setForm = function (form) {
        this.form = form;
    };
    ItemConfigBase.prototype.setConfig = function (next) {
    ...
    ItemConfigBase.prototype.getComputedValue = function (key, target, defaultValue) {
        var _this = this;
        ...
        try {
            ...
            if (!(/(^refConfig$)|^(on|get(.*?))|((.*?)Method)$|(.*?)filter(.*?)/.test(key)) && (keyValue_1 instanceof Function)) {
                var computedValue = mobx_utils_1.expr(function () { return keyValue_1(_this.formSource || {}, _this); });
    ...
    Object.defineProperty(ItemConfigBase.prototype, "type", {
        get: function () {
            return this.i.type;
        },
        enumerable: true,
    ...
    Object.defineProperty(ItemConfigBase.prototype, "code", {
        get: function () {
            return this.i.code;
        },
        enumerable: true,
    ...
    Object.defineProperty(ItemConfigBase.prototype, "nameCode", {
        get: function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        nextOptions = [];
                        if (!Utils_1.Utils.isFunction(remoteMethod)) return [3 /*break*/, 7];
    ...
    Object.defineProperty(ItemConfigBase.prototype, "loading", {
        get: function () {
    ...
    ItemConfigBase.prototype.setLoading = function (v) {
    ...
    Object.defineProperty(ItemConfigBase.prototype, "options", {
        /**
         * @type { Array } 配置项Array
         */
        get: function () {
    ...
    ItemConfigBase.prototype.getOptions = function () {
    ...
    ItemConfigBase.prototype.setOptions = function (v) {
    ...
    ItemConfigBase.prototype.export = function () {
        var e_5, _a;
        var model = {};
        try {
    ...
    Object.defineProperty(ItemConfigBase.prototype, "defaultRule", {
        get: function () {
            return Object.assign(ItemConfigBase_1.getDefaultRules(this, this.componentProps), Date_1.getDefaultRules(this));
        },
        enumerable: true,
        configurable: true
    });
                    ...
                    validator: function (rule, value, callback) {
                        ...
                        if (Utils_1.Utils.isNotEmptyString(value)) {
                            if (lodash_1.trim(value) === '*' || value.indexOf('新车') > -1 || (itemConfig.code !== 'licanseNo' && value === '车外')) {
                                ...
                                var selected = Utils_1.Utils.getOptionsByValue(lodash_1.get(configStore, '$store.state.taskDispatcher.licenseTypeList'), form.licenseType);
    ...
    var ItemConfigBase_1;
    __decorate([
        mobx_1.observable.ref,
        __metadata("design:type", Object)
    ], ItemConfigBase.prototype, "i", void 0);
    __decorate([
        mobx_1.observable.ref,
        __metadata("design:type", Array)
    ], ItemConfigBase.prototype, "iKeys", void 0);
    __decorate([
        mobx_1.observable.ref,
        __metadata("design:type", Object)
    ], ItemConfigBase.prototype, "form", void 0);
    __decorate([
        mobx_1.observable.ref,
        __metadata("design:type", Object)
    ], ItemConfigBase.prototype, "componentProps", void 0);
    __decorate([
    ...
    __decorate([
        mobx_1.observable,
        __metadata("design:type", Object)
    ], ItemConfigBase.prototype, "displayConfig", void 0);
    __decorate([
        mobx_1.computed,
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ], ItemConfigBase.prototype, "displayProps", null);
    __decorate([
        mobx_1.computed,
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ], ItemConfigBase.prototype, "isViewOnly", null);
    __decorate([
        mobx_1.computed,
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", [Object]),
        __metadata("design:returntype", void 0)
    ], ItemConfigBase.prototype, "setForm", null);
    __decorate([
        mobx_1.action.bound,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
    ...
    __decorate([
        ...
        __metadata("design:returntype", void 0)
    ], ItemConfigBase.prototype, "getComputedValue", null);
    __decorate([
        mobx_1.computed.struct,
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ], ItemConfigBase.prototype, "type", null);
    __decorate([
        mobx_1.computed.struct,
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ], ItemConfigBase.prototype, "code", null);
    __decorate([
        mobx_1.computed.struct,
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ], ItemConfigBase.prototype, "nameCode", null);
    __decorate([
        mobx_1.computed.struct,
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ...
    __decorate([
        ...
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ], ItemConfigBase.prototype, "loading", null);
    __decorate([
        mobx_1.action.bound,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Boolean]),
        __metadata("design:returntype", void 0)
    ], ItemConfigBase.prototype, "setLoading", null);
    __decorate([
        mobx_1.computed,
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ...
    __decorate([
        ...
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [])
    ], ItemConfigBase.prototype, "options", null);
    __decorate([
        core_decorators_1.autobind,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Array)
    ], ItemConfigBase.prototype, "getOptions", null);
    __decorate([
        mobx_1.action.bound,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
        __metadata("design:returntype", void 0)
    ], ItemConfigBase.prototype, "setOptions", null);
    __decorate([
        mobx_1.action,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
    ...
    ItemConfigBase = ItemConfigBase_1 = __decorate([
        EventStore_1.EventStoreInject(['options-change']),
        __metadata("design:paramtypes", [Object, Object, Object])
    ], ItemConfigBase);
    return ItemConfigBase;
}(ItemConfig_1.CommonStore));
exports.ItemConfigBase = ItemConfigBase;
