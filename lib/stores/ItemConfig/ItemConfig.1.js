...
var ItemConfig = /** @class */ (function () {
    function ItemConfig(initModel, form, componentProps) {
        ...
        this.searchStore = new SearchStore_1.SearchStore(this);
    ...
    Object.defineProperty(ItemConfig.prototype, "defaultRule", {
        get: function () {
            return Object.assign(ItemConfig_1.getDefaultRules(this, this.componentProps), Date_1.getDefaultRules(this));
        },
        enumerable: true,
        configurable: true
    });
