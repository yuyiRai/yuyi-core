...
var SearchStore = /** @class */ (function (_super) {
    ...
    function SearchStore(itemConfig) {
        ...
        _this.mode = 'search';
        _this.searchKeyHistory = mobx_1.observable.array([]);
        _this.searchResult = [];
        ...
        mobx_1.intercept(_this.searchKeyHistory, function (change) {
        ...
        console.log('useSearchStore', _this);
        _this.resetKeyword();
        return _this;
    ...
    Object.defineProperty(SearchStore.prototype, "keyWord", {
        get: function () {
            ...
            var key = history.length === 0 ? undefined : Utils.toString(history[history.length - 1]);
            return key === '*' ? '' : key;
        },
        enumerable: true,
        configurable: true
