...
var SearchStore = /** @class */ (function (_super) {
    ...
    function SearchStore(itemConfig) {
        ...
        _this.loadDataBuffer = Utils.createSimpleTimeBufferInput(function (dataPathBuffer) { return __awaiter(_this, void 0, void 0, function () {
            var e_1, _a, dataPathBuffer_1, dataPathBuffer_1_1, keyPath, optionsList, e_1_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _b.label = 1;
                    case 1:
                        if (!!dataPathBuffer_1_1.done) return [3 /*break*/, 4];
    ...
    SearchStore.prototype.multipleRemoteSearch = function (keyWord) {
        return __awaiter(this, void 0, void 0, function () {
            var e_2, _a, remoteMethod, nextOptions, keyWordArr, keyWordArr_1, keyWordArr_1_1, keyWord_1, _b, _c, _d, e_2_1;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 7:
                        try {
                            if (keyWordArr_1_1 && !keyWordArr_1_1.done && (_a = keyWordArr_1.return)) _a.call(keyWordArr_1);
                        }
