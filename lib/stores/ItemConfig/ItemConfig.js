...
var ItemConfig = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ItemConfig, "commonTransformer", {
        get: function () {
            return mobx_utils_1.createTransformer(this.commonTransformerConfig || function (_a) {
    ...
    ItemConfig.prototype.useSearchStore = function (transformer, config) {
        ...
        var store = this.searchStore || new SearchStore_1.SearchStore(config);
    ...
    Object.defineProperty(ItemConfig.prototype, "formValueTransform", {
        get: function () {
            return FormValueTransform_1.default(this.transformer);
        },
        enumerable: true,
        configurable: true
    });
    ...
    ItemConfig.prototype.useOptionsStore = function (transformer, config) {
        if (config === void 0) { config = this; }
        var store = this.optionsStore || new SelectAndSearchStore_1.OptionsStore(config, transformer);
