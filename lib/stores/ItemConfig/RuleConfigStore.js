...
var RuleStore = /** @class */ (function (_super) {
    ...
    RuleStore.setRuleErrorIntercept = function (register) {
        this.ruleErrorIntercept = (register);
    };
    RuleStore.prototype.useRuleErrorIntercept = function (validator) {
    ...
    Object.defineProperty(RuleStore.prototype, "ruleGetterParams", {
        get: function () {
    ...
    RuleStore.prototype.ruleConvert = function (rule, i) {
        var _this = this;
    ...
    RuleStore.prototype.convertRegExpToFunction = function (ruleGetter) {
        return function (rule, value, callback) {
    ...
    Object.defineProperty(RuleStore.prototype, "defaultRule", {
        get: function () {
            return Object.assign(RuleStore.getDefaultRules(), getDefaultRules(this.itemConfig));
        },
        enumerable: true,
        configurable: true
    });
    RuleStore.registerCustomRule = function (key, rule) {
        this.customRuleMap.set(key, rule);
    };
    RuleStore.getDefaultRules = function () {
        return this.customRuleMap.toPOJO();
    };
    RuleStore.customRuleMap = observable.map({});
    __decorate([
        observable,
    ...
    ], RuleStore.prototype, "useRuleErrorIntercept", null);
    __decorate([
        computed,
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [])
    ], RuleStore.prototype, "ruleGetterParams", null);
    __decorate([
        autobind,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object]),
        __metadata("design:returntype", Array)
    ], RuleStore.prototype, "ruleConvert", null);
    __decorate([
        autobind,
        __metadata("design:type", Function),
    ...
    __decorate([
        observable,
        __metadata("design:type", Function)
    ], RuleStore, "ruleErrorIntercept", void 0);
    __decorate([
        action.bound,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Function]),
        __metadata("design:returntype", void 0)
    ], RuleStore, "setRuleErrorIntercept", null);
    __decorate([
        observable,
        __metadata("design:type", ObservableMap)
    ], RuleStore, "customRuleMap", void 0);
    __decorate([
        action.bound,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [String, Object]),
        __metadata("design:returntype", void 0)
    ], RuleStore, "registerCustomRule", null);
    return RuleStore;
}(CommonStore));
export { RuleStore };
