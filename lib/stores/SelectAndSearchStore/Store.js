...
var ItemConfigBase_1 = require("../ItemConfig/ItemConfigBase");
var ItemConfig_1 = require("../ItemConfig/ItemConfig");
...
var SelectAndSearchStore = /** @class */ (function () {
    ...
    SelectAndSearchStore.prototype.onChange = function (value, source) {
            ...
            return _.map(this.selectedLables, function (label) {
                return {
                    ...
                    remove: function () {
                        ...
                        _this.onChange(_.pullAll(__spread(utils_1.default.castArray(_this.value)), _this.labelsToValues(label)), 'options delete');
                    }
                };
            });
        },
    ...
    SelectAndSearchStore = SelectAndSearchStore_1 = __decorate([
        EventStore_1.EventStoreInject(['change', 'change-with', 'options-change'], { itemConfig: ItemConfigBase_1.ItemConfigBase })
