...
var SelectAndSearchStore = /** @class */ (function () {
    ...
    SelectAndSearchStore.prototype.onChangeWithLabel = function (label) {
        var value = this.OptionsStore2.labelToValue(label);
    ...
    SelectAndSearchStore.prototype.onChange = function (value, source) {
        if (!Utils.isEqual(value, this.value)) {
            ...
            var isAllowCreateOption = allowCreate && !isSelected && Utils.isNotEmptyValue(value) && this.OptionsStore2.isValidShadowOption;
            ...
            return _.map(this.selectedLables, function (label) {
                return {
                    ...
                    remove: function () {
                        ...
                        _this.onChange(_.pullAll(__spread(Utils.castArray(_this.value)), _this.labelsToValues(label)), 'options delete');
                    }
                };
            });
        },
    ...
    ], SelectAndSearchStore.prototype, "OptionsStore2", void 0);
    __decorate([
        observable.ref,
