...
var OptionsStore = /** @class */ (function () {
    ...
    Object.defineProperty(OptionsStore.prototype, "selectedLablesConfig", {
        get: function () {
            var _this = this;
            var value = this.itemConfig.currentComponentValue;
            return utils_1.default.arrayMapDive(this.selectedLables, function (label, index) {
                return {
                    label: label,
                    value: utils_1.default.labelToValue(_this.displayOptions, label),
                    remove: function (onChange) {
                        onChange(lodash_1.pullAll(__spread(utils_1.default.castArray(value)), _this.labelsToValues(label)));
                    }
                };
            });
        },
