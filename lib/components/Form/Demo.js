...
var props = {
    ...
    config: [
        { label: '姓名', code: 'name', suffix: React.createElement(antd_1.Icon, { type: 'plus' }), required: function (form) { return !form.showVoiceroid; }, rule: 'commonCode' },
        ...
        { label: 'B', code: 'info.voiceroid', type: "check", options: voiceroid, hidden: function (form) { return !form.showVoiceroid; } },
        { label: 'C', code: 'info.voiceroid2', type: "radio", options: voiceroid, hidden: function (form) { return !form.showVoiceroid; } },
        { label: '产品介绍', code: 'info.introduce', type: "textarea", options: voiceroid, hidden: function (form) { return !form.showVoiceroid; } },
    ]
};
