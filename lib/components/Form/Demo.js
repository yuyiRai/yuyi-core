...
var options = [{ label: 'A', value: 'a' }, { label: 'B', value: 'b' }, { label: 'C1', value: 'c1' }, { label: 'A1', value: 'a1' }, { label: 'B1', value: 'b1' }, { label: 'C', value: 'c' }];
var model = {
    name: 'yuyi',
...
var config = [
    ...
    { label: '单选', code: 'search', type: "search", options: options, nameCode: 'searchName' },
    { label: '多选', code: 'search2', type: "search", nameCode: 'search2Name', multiple: true, remoteMethod: function (key) {
