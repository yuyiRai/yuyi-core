...
describe("FormStoreCore", function () {
    beforeEach(function () {
        store.setConfig([{ code: "name" }, { code: "password" }]);
    });
    it("configMap", function () { return __awaiter(_this, void 0, void 0, function () {
        var name;
        return __generator(this, function (_a) {
            name = store.configStore.getItemConfig("name");
...
//# sourceMappingURL=FormStoreCore.test.js.map