...
var FormItem_1 = require("./Interface/FormItem");
var lodash_decorators_1 = require("lodash-decorators");
var core_decorators_1 = require("core-decorators");
var immer_1 = __importDefault(require("immer"));
var FormItem_2 = require("./FormItem");
var EventEmitter_1 = require("../../utils/EventEmitter");
var EventStore_1 = require("../../utils/EventStore");
var FormValueTransform_1 = __importDefault(require("../../stores/ItemConfig/input/FormValueTransform"));
...
var FormStore = /** @class */ (function (_super) {
    ...
    Object.defineProperty(FormStore.prototype, "itemCodeList", {
        get: function () {
            return this.config.map(function (i) { return i.code; });
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(FormStore.prototype, "itemCodeNameMap", {
        get: function () {
    ...
    Object.defineProperty(FormStore.prototype, "itemCodeNameList", {
        get: function () {
            return lodash_1.values(this.itemCodeNameMap);
        },
        enumerable: true,
        configurable: true
    });
        ...
        var _loop_1 = function (key, data) {
            ...
            if (data.name === pathStr) {
                ...
                if (data.validating !== true) {
                    console.log('hasError', data.name, data, utils_1.isNotEmptyArray(data.errors));
                    if (data.validating === false) {
                        // this.errorGroup.set(key, isNotEmptyArray(data.errors) ? data.errors : null)
                        this_1.updateError(data.name, data.errors);
                    }
                    ...
                    if (utils_1.Utils.isFunction(callback)) {
                        ...
                        var isChanged = this_1.setFormValue(data.value, key);
                        Object.assign(result, (_a = {}, _a[key] = isChanged, _a));
                    }
                }
            }
            else {
                var next = this_1.patchFieldsChange(data, nextpath, callback || (function (pathStr, value) {
                    var _a;
                    var innerPath = pathStr.replace(key + '.', '');
                    var isChanged = _this.setFormValue(value, key, innerPath);
    ...
    Object.defineProperty(FormStore.prototype, "formValueTransform", {
        get: function () {
            var _this = this;
            return utils_1.Utils.reduce(this.config, function (nextMap, i) {
                var key = i.code;
                var store = _this.formItemStores[key];
                return nextMap.set(key, (store && store.itemConfig.formValueTransform) || FormValueTransform_1.default(i.type));
            }, new Map());
        },
        enumerable: true,
        configurable: true
    ...
    FormStore.prototype.setFormValue = function (value, key, innerPath) {
        var _this = this;
        var isChanged;
        var nextValue;
        var pathStr = key;
        if (utils_1.Utils.isNotEmptyString(innerPath)) {
            pathStr += '.' + innerPath;
            var preObj = this.formMap.get(key) || {};
            var obj = immer_1.default(preObj, function (i) {
                if (!utils_1.Utils.isEqual(lodash_1.get(i, innerPath), value, true)) {
                    var toValue = _this.getV2FValue(pathStr, value);
                    lodash_1.set(i, innerPath, toValue);
                }
            });
            nextValue = obj;
            ...
            isChanged = !utils_1.Utils.isEqual(this.formSource[key], nextValue, true);
        }
        if (isChanged) {
    ...
    FormStore.prototype.setFormValueWithName = function (code) {
        var nameCode = this.itemCodeNameMap[code];
        var optionsStore = this.formItemStores[code].itemConfig.optionsStore;
        if (utils_1.Utils.isNotEmptyString(nameCode) && nameCode !== code) {
            ...
            console.log('get nameCode', 'formMap', optionsStore, optionsStore.selectedLables);
            lodash_1.set(this.formSource, nameCode, optionsStore.selectedLablesStr);
        }
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        r = (_a.sent()) && this.antdForm.validateFields(this.itemCodeList, { force: true });
                        console.log(r);
                        return [2 /*return*/];
                }
            });
    ...
    FormStore.prototype.registerItemStore = function (code) {
        ...
        this.formItemStores[code] = this.formItemStores[code] || new FormItem_2.FormItemStore(this, code);
    ...
    FormStore.prototype.registerKey = function (target, deep) {
        ...
        try {
            for (var _c = __values(this.itemCodeList), _d = _c.next(); !_d.done; _d = _c.next()) {
                var code = _d.value;
        ...
        try {
            for (var _e = __values(this.itemCodeNameList), _f = _e.next(); !_f.done; _f = _e.next()) {
                var code = _f.value;
                console.log('registerKey', code);
                registerKey(target, code, deep);
            }
    ...
    __decorate([
        ...
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ], FormStore.prototype, "itemCodeList", null);
    __decorate([
        mobx_1.computed,
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ], FormStore.prototype, "itemCodeNameMap", null);
    __decorate([
        mobx_1.computed,
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ], FormStore.prototype, "itemCodeNameList", null);
    __decorate([
        core_decorators_1.autobind,
        __metadata("design:type", Function),
    ...
    __decorate([
        ...
        __metadata("design:returntype", void 0)
    ], FormStore.prototype, "setFormValueWithName", null);
    __decorate([
        core_decorators_1.autobind,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
    ...
    __decorate([
        ...
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [String]),
        __metadata("design:returntype", FormItem_2.FormItemStore)
    ...
    FormStore = FormStore_1 = __decorate([
        EventStore_1.EventStoreInject(['onItemChange']),
        __metadata("design:paramtypes", [])
    ], FormStore);
    return FormStore;
}(GFormStore));
