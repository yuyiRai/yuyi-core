...
var Form = /** @class */ (function (_super) {
    ...
    Form.getDerivedStateFromProps = function (nextProps, prevState) {
        var form = nextProps.form, formStore = nextProps.formStore, _a = nextProps.formItemLayout, formItemLayout = _a === void 0 ? defaultFormItemLayout : _a;
        if (formStore instanceof FormStore) {
            ...
            if (formStore !== prevState.lastStore) {
                ...
                prevState.itemChildren = (Array.from((formStore.configStore.configList), function (config, i) { return React.createElement(FormItem, __assign({}, formItemLayout, { key: i, code: config.code })); }));
                prevState.form = form;
        ...
        return (React.createElement(FormContainer, __assign({}, this.props),
            React.createElement(Provider, { antdForm: form, formStore: this.props.formStore },
                React.createElement(React.Fragment, null,
                    React.createElement(Row, { className: className }, this.state.itemChildren),
