...
var Form = /** @class */ (function (_super) {
    ...
    Form.getDerivedStateFromProps = function (nextProps, prevState) {
        ...
        if (storeForm instanceof FormStore_1.FormStore) {
            ...
            if (storeForm !== prevState.lastStore) {
                ...
                // </For>
                storeForm.configList.map(function (config) {
                    return React.createElement(FormItem_1.default, __assign({}, formItemLayout, { key: config.code, code: config.code }));
                }));
                // prevState.a = (
    ...
    Form.prototype.render = function () {
        ...
        return (React.createElement(mobx_react_1.Provider, { antdForm: form, storeForm: this.props.storeForm },
...
exports.FormGroup = function (props) {
    return (React.createElement(CommonForm_1.NativeStore.Consumer, null, function (value) {
        console.log('fromgroup get store', props, value);
        return (React.createElement(mobx_react_lite_1.Observer, { render: function () { return (value.storeForm && React.createElement(exports.InjectedForm, __assign({}, props, { storeForm: value.storeForm }))); } }));
    }));
};
