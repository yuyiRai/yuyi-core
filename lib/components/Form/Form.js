...
var Form = /** @class */ (function (_super) {
    ...
    Form.getDerivedStateFromProps = function (nextProps, prevState) {
        ...
        if (formStore instanceof FormStore_1.FormStore) {
            ...
            if (formStore !== prevState.lastStore) {
                ...
                // </For>
                formStore.configList.map(function (config) {
    ...
    Form.prototype.render = function () {
        ...
        return (React.createElement(mobx_react_1.Provider, { antdForm: form, formStore: this.props.formStore },
...
exports.FormGroup = function (props) {
    return (React.createElement(CommonForm_1.NativeStore.Consumer, null, function (value) {
        ...
        return (React.createElement(mobx_react_lite_1.Observer, { render: function () { return (value.formStore && React.createElement(exports.InjectedForm, __assign({}, props, { formStore: value.formStore }))); } }));
    }));
};
