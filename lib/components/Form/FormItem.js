...
var FormItemStore = /** @class */ (function () {
    function FormItemStore(storeForm, code) {
        var _this = this;
        this.getFieldDecorator = function (store) {
            var code = store.code, antdForm = store.antdForm, storeForm = store.storeForm;
            var itemConfig = store.itemConfig;
            var value = itemConfig.value;
            var hasError = storeForm.hasErrors(itemConfig.code);
        ...
        this.getFieldDecoratorOptions = mobx_utils_1.createTransformer(function (itemConfig) {
            ...
            return {
                ...
                rules: itemConfig.rule, initialValue: itemConfig.value, getValueProps: function () {
                    // console.log('value filter', itemConfig, props);
                    return { value: utils_1.default.isNotEmptyValueFilter(itemConfig.currentValue, itemConfig.value) || null };
                }
            };
        }, { debugNameGenerator: function () { return 'getFieldDecoratorOptions'; } });
        this.storeForm = storeForm;
        this.itemConfig = new stores_1.ItemConfig(storeForm.getConfig(code), storeForm.formSource, this);
    ...
    FormItemStore.prototype.init = function () {
        var _this = this;
        var _a = this, storeForm = _a.storeForm, code = _a.code;
        // reaction(() => this.fieldDecorator, () => {
        //   console.log('fieldDecorator change', code)
        // })
        this.validateReset = mobx_1.autorun(function () {
            if (!storeForm.hasErrors(code) || !_this.itemConfig.rule) {
                storeForm.reactionAntdForm(function (antdForm) {
    ...
    ], FormItemStore.prototype, "storeForm", void 0);
    __decorate([
...
var FormItem = /** @class */ (function (_super) {
    ...
    FormItem = __decorate([
        mobx_react_1.inject(function (stores, props, context) {
            ...
            var storeForm = stores.storeForm;
            var store = storeForm.registerItemStore(props.code);
