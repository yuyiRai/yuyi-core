...
var FormItemStore = /** @class */ (function (_super) {
    ...
    function FormItemStore(formStore, code) {
        ...
        _this.getFieldDecorator = function (store) {
            var code = store.code, antdForm = store.antdForm;
        ...
        _this.ruleWatcher = reaction(function () { return _this.itemConfig.rule; }, function (rule) {
    ...
    Object.defineProperty(FormItemStore.prototype, "Component", {
        get: function () {
            ...
            return React.createElement(Component, { code: code, antdForm: antdForm, disabled: displayProps.isDisabled, placeholder: itemConfig.placeholder });
        },
        enumerable: true,
        configurable: true
    });
...
var FormItem = /** @class */ (function (_super) {
    ...
    FormItem.prototype.render = function () {
        ...
        return store.renderer(React.createElement(OAntFormItem, __assign({ itemConfig: itemConfig }, other, { validateStatus: hasError ? 'error' : 'success', hasFeedback: false }),
            React.createElement(FormItemLoading, { code: code }, store.fieldDecorator(React.cloneElement(store.Component)))));
    };
    FormItem = __decorate([
        inject(function (stores, props, context) {
            // console.log('fromitem get store', stores, props, context)
            var formStore = stores.formStore;
            var store = formStore.registerItemStore(props.code, FormItemStore);
