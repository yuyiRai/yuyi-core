...
function useSearchStore(itemConfig, transformer) {
    // reaction(()=>itemConfig.options, console.log)
    return mobx_react_lite_1.useAsObservableSource(itemConfig.useSearchStore(transformer));
}
exports.useSearchStore = useSearchStore;
function useItemConfig(itemConfig) {
    // reaction(()=>itemConfig.options, console.log)
    return mobx_react_lite_1.useAsObservableSource(itemConfig);
}
exports.useItemConfig = useItemConfig;
