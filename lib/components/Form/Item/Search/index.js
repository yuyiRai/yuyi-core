...
export var OSearchItem = styled(function (props) {
    ...
    return (React.createElement(Observer, null, function () {
        ...
        if (isAutoComplete) {
            return React.createElement(AutoComplete, __assign({}, other, { onSearch: searchStore.onSearch, dataSource: transformOption }));
        }
...
}).withConfig({ displayName: "OSearchItem", componentId: "sc-lkswux" })(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  text-align: ", ";\n"], ["\n  text-align: ", ";\n"])), function (props) { return props.center ? 'center' : undefined; });
