...
exports.DatePickerItem = mobx_react_1.inject('storeForm', 'antdForm', 'itemConfig')(mobx_react_1.observer(function (_a) {
...
exports.DateRangePickerItem = mobx_react_1.inject('storeForm', 'antdForm', 'itemConfig')(mobx_react_1.observer(function (_a) {
    var antdForm = _a.antdForm, storeForm = _a.storeForm, code = _a.code, itemConfig = _a.itemConfig, other = __rest(_a, ["antdForm", "storeForm", "code", "itemConfig"]);
