...
var Check = function (_a) {
    ...
    if (itemConfig.useSlot) {
        var slot_1 = scopedSlots[itemConfig.slot];
        var slotFactory = function (options, index) { return slot_1({
            col: {
                data: other.value,
                item: options,
                index: index,
        ...
        return (React.createElement("div", { className: 'el-checkbox-group' }, Array.from((store.displayOptions), function (option, i) { return React.createElement("span", { key: i }, slotFactory(option, i)); })));
    }
