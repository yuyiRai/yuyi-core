...
var SelectAndSearchStore = /** @class */ (function () {
            ...
            return _.map(this.selectedLables, function (label) {
                return {
                    ...
                    remove: function () {
                        ...
                        _this.onChange(_.pullAll(_this.value.slice(), _this.labelsToValues(label)));
                    }
                };
            });
        },
    ...
    SelectAndSearchStore.getConvertLabel = function (str) {
        var _a = Utils.isStringFilter(str, ',,').replace(/^(\[(.*?)\]|)(.*?)(\[(.*?)\]|)$/, '$2,$3,$5').split(','), prefix = _a[0], label = _a[1], suffix = _a[2];
