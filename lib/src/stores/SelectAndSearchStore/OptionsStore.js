    ...
    Object.defineProperty(OptionsStore.prototype, "__optionArr", {
        get: function () {
            ...
            try {
                ...
                for (var _b = __values(Utils.isArrayFilter(options) || []), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var item = _c.value;
                    if (!Utils.isNil(item)) {
                        var index = next.length;
                        next.push(Utils.isObject(item) ? (item.__key == null ? __assign({}, item, { __key: OptionsStore_1.getOptionsKey(item, index) }) : item) : {
