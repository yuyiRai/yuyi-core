...
var OptionsStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        if (!utils_1.default.isNotEmptyString(value)) return [3 /*break*/, 2];
    ...
    Object.defineProperty(OptionsStore.prototype, "__optionArr", {
        get: function () {
            ...
            try {
                ...
                for (var _b = __values(utils_1.default.isArrayFilter(options) || []), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var item = _c.value;
                    if (!utils_1.default.isNil(item)) {
                        var index = next.length;
                        next.push(utils_1.default.isObject(item) ? (item.__key == null ? __assign({}, item, { __key: OptionsStore_1.getOptionsKey(item, index) }) : item) : {
    ...
    OptionsStore.prototype.toConvertedOption = function (item, index) {
        if (!this.__optionMap.get(item)) {
            ...
            this.__optionMap.set(item, __assign({}, item, { key: item.__key + "." + this.__keyMap[item.__key], label: utils_1.default.isStringFilter(item.label, item.value, (utils_1.default.isObject(item) ? index : item) + ''), value: utils_1.default.isStringFilter(item.value, (utils_1.default.isObject(item) ? index : item) + '') }));
        }
    ...
    Object.defineProperty(OptionsStore.prototype, "convertedOption", {
        get: function () {
            ...
            var result = utils_1.default.arrayMapDive(this.__optionArr, this.toConvertedOption);
    ...
    __decorate([
        mobx_1.action.bound,
        utils_1.default.logger('testt'),
        utils_1.default.timebuffer(10),
        __metadata("design:type", Function),
