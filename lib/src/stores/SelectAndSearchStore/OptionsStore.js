        ...
        for (const item of Utils.isArrayFilter(options) || []) {
            if (!Utils.isNil(item)) {
                ...
                next.push(Utils.isObject(item)
                    ? (item.__key == null ? { ...item, __key: OptionsStore_1.getOptionsKey(item, index) } : item)
                    : {
...
__decorate([
    autobind,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_a = typeof Option !== "undefined" && Option) === "function" ? _a : Object, Number]),
    __metadata("design:returntype", typeof (_b = typeof Option !== "undefined" && Option) === "function" ? _b : Object)
