...
var ItemConfig = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        nextOptions = [];
                        if (!Utils_1.Utils.isFunction(remoteMethod)) return [3 /*break*/, 9];
                        this.setLoading(true);
                        if (!multiple) return [3 /*break*/, 6];
                        keyWordArr = Utils_1.Utils.zipEmptyData(Utils_1.Utils.castArray(keyWord));
                        if (!(keyWordArr.length > 0)) return [3 /*break*/, 5];
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                    ...
                    case 6: return [4 /*yield*/, remoteMethod(lodash_1.toString(keyWord))
    ...
    Object.defineProperty(ItemConfig.prototype, "defaultRule", {
        get: function () {
            return this.$version > -1 && Object.assign(ItemConfig_1.getDefaultRules(this, this.componentProps.$store.state.taskDispatcher), Date_1.getDefaultRules(this));
        },
        enumerable: true,
        configurable: true
    });
