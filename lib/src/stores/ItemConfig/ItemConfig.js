...
var ItemConfig = /** @class */ (function () {
        ...
        this.reaction(function () { return _this.i; }, function (i) {
            ...
            _this.observe(i, function (e) {
                ...
                if (e.name === '$$core_options') {
                    _this.label === '诊断名称' && console.log(e.name + ": " + e.oldValue + " => " + e.newValue, { config: i, event: e });
    ...
    Object.defineProperty(ItemConfig.prototype, "options", {
        ...
        get: function () {
            // trace()
            this.label === '归属车辆' && console.log('伤者类型 get options', Utils_1.Utils.isArrayFilter(this.$version, this.getComputedValue('options'), []));
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getOptionsSafe()];
                    case 1:
                        options = _d.sent();
                        try {
