    ...
    function ItemConfig(initModel, form, componentProps) {
        ...
        this.reaction(function () { return _this.i; }, function (i) {
            ...
            _this.observe(i, function (e) {
                ...
                if (name === '$$core_options' && !Utils_1.Utils.isEqual(oldValue, newValue)) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (this.type === 'search' && (this.options.length === 0 || !this.optionsInited)) {
                    if (!Utils_1.Utils.isArrayFilter(this.remoteOptions)) {
                        console.log('safe start', this.label, this.remoteOptions, this.options);
                        b_1 = mobx_1.reaction(function () { return _this.remoteOptions; }, function (options) {
