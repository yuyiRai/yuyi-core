...
var ItemConfig = /** @class */ (function () {
    function ItemConfig(initModel, form, componentProps) {
        ...
        this.validateHandler = function (value) {
            return new Promise(function (resolve, reject) {
                var resultList = [];
                if ((Utils.isArrayFilter(_this.rule) || []).length === 0) {
                    return resolve(true);
                }
                if (_this.rule) {
        ...
        this.reaction(function () { return _this.i; }, function (i) {
            ...
            for (var _i = 0, _a = ['loading', 'options']; _i < _a.length; _i++) {
                var name_1 = _a[_i];
                _this.registerKey(i, name_1);
            }
            observe(i, function (e) {
                _this.$version++;
                // console.log(e)
    ...
    ItemConfig.prototype.registerObservables = function (baseConfig) {
            ...
            if (!isComputedProp(this_1, key)) {
                ...
                extendObservable(this_1, (_a = {},
                    Object.defineProperty(_a, key, {
                        get: function () {
                            return Utils.isNumber(thisArg_1.$version) && thisArg_1.getComputedValue(key, baseConfig);
                        },
                        enumerable: true,
                        configurable: true
                    }),
        ...
        var this_1 = this;
        for (var _i = 0, _a = this.otherKey; _i < _a.length; _i++) {
            var key = _a[_i];
            _loop_2(key);
        }
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        nextOptions = [];
                        if (!Utils.isFunction(remoteMethod)) return [3 /*break*/, 6];
                        ...
                        return [4 /*yield*/, Promise.all(map(keyWordArr, function (keyWord) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 2:
                                            e_1 = _a.sent();
                                            Utils.$message.error(e_1.message || e_1);
                                            return [3 /*break*/, 3];
                    ...
                    case 3: return [4 /*yield*/, remoteMethod(toString(keyWord))
    ...
    ItemConfig.prototype.destory = function () {
        for (var _i = 0, _a = this.destorySet; _i < _a.length; _i++) {
            var destory = _a[_i];
            destory();
        }
    ...
    ItemConfig.prototype.getRuleList = function (i, componentProps) {
        ...
        if (Utils.isNotEmptyString(ruleGetter)) {
            var _a = ruleGetter.split('|'), ruleName = _a[0], message_1 = _a[1];
            ...
            iRules.push.apply(iRules, defaultRuleList);
        }
        else if (Utils.isNotEmptyArray(ruleGetter)) {
            iRules.push.apply(iRules, ruleGetter);
        }
        ...
        if (Utils.isNotEmptyArray(componentProps.rules)) {
            iRules.push.apply(iRules, componentProps.rules);
        }
    ...
    ItemConfig.prototype.optionsMatcher = function (r, values, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var options, _i, _a, value;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getOptionsSafe()];
                    case 1:
                        options = _b.sent();
                        for (_i = 0, _a = values.split(','); _i < _a.length; _i++) {
                            value = _a[_i];
    ...
    ItemConfig.prototype.getOptionsSafe = function () {
        ...
        if (this.type === 'search' && (this.options.length === 0 || !this.optionsInited)) {
            return this.remoteOptions || new Promise(function (r) {
                ...
                var b = reaction(function () { return _this.remoteOptions; }, function (options) {
                    r(options);
                    ...
                    validator: function (rule, value, callback) {
                        ...
                        if (Utils.isNotEmptyString(value)) {
                            if (trim(value) === '*' || value.indexOf('新车') > -1 || (itemConfig.code !== 'licanseNo' && value === '车外')) {
                                ...
                                var selected = Utils.getOptionsByValue(configStore.licenseTypeList, form.licenseType);
