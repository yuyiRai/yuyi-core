...
var AsyncProperty_1 = require("../../utils/AsyncProperty");
var Utils_1 = require("../../utils/Utils");
var FormItemPipe_1 = require("../../components/FormPage/FormItemPipe");
var DatePickerItem_js_1 = require("../../components/FormPage/input-Item/DatePickerItem.js");
var ItemConfig = /** @class */ (function () {
    function ItemConfig(initModel, form, componentProps) {
        ...
        this.validateHandler = function (value) {
            return new Promise(function (resolve, reject) {
                var e_1, _a;
                var resultList = [];
                if ((Utils_1.Utils.isArrayFilter(_this.rule) || []).length === 0) {
                    return resolve(true);
                }
                if (_this.rule) {
                    var length_1 = _this.rule.length;
                    var _loop_1 = function (rule) {
                        var validator = Utils_1.Utils.isFunctionFilter(rule.validator) || (function (a, b, c) { return c(true); });
                        validator(_this.rule, value, function (e) {
                            resultList.push(rule);
                            if (lodash_1.isError(e)) {
                                reject(e.message || rule.message);
                            }
                            else if (resultList.length === length_1) {
                                resolve(true);
                            }
                        });
                    };
                    try {
                        for (var _b = __values(_this.rule), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var rule = _c.value;
                            _loop_1(rule);
                        }
                    }
        ...
        this.reaction(function () { return _this.i; }, function (i) {
            ...
            try {
                ...
                for (var _b = __values(['loading', 'options']), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var name_1 = _c.value;
            ...
            _this.$emit('options-change', _this.options);
            ...
            if (!mobx_1.isComputedProp(this_1, key)) {
                ...
                mobx_1.extendObservable(this_1, (_a = {},
                    Object.defineProperty(_a, key, {
                        get: function () {
                            return Utils_1.Utils.isNumber(thisArg_1.$version) && thisArg_1.getComputedValue(key, baseConfig);
                        },
                        enumerable: true,
                        configurable: true
                    }),
    ...
    ItemConfig.prototype.registerKey = function (i, key) {
        var defaultV = i[key];
        var coreKey = "$$core_" + key;
    ...
    ItemConfig.prototype.getComputedValue = function (key, target, defaultValue) {
        ...
        var keyValue = target[key]; //(action(Utils.getPropertyFieldByCreate))(this.i, [key, defaultValue])
        // if(keyValue !== this.i[key]) {
        //   this.updateVersion()
        // }
        if (!(/(^refConfig$)|^(on|get(.*?))|((.*?)Method)$|(.*?)filter(.*?)/.test(key)) && (keyValue instanceof Function)) {
            var computedValue = keyValue(this.form || {}, this);
            return Utils_1.Utils.isNil(computedValue) ? defaultValue : computedValue;
        }
        return keyValue;
    };
    Object.defineProperty(ItemConfig.prototype, "required", {
        /**
         * 是否控制必录
         */
        get: function () {
    ...
    Object.defineProperty(ItemConfig.prototype, "hidden", {
        /**
         * 是否
         */
        get: function () {
    ...
    Object.defineProperty(ItemConfig.prototype, "label", {
        get: function () {
    ...
    ItemConfig.prototype.remoteSearch = function (keyWord) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, remoteMethod, multiple, nextOptions, keyWordArr;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                        ...
                        return [4 /*yield*/, Promise.all(lodash_1.map(keyWordArr, function (keyWord) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            _a.trys.push([0, 2, , 3]);
                                            return [4 /*yield*/, remoteMethod(keyWord, this.form)];
                                        case 1:
                                            data = _a.sent();
                                        ...
                                        case 2:
                                            e_4 = _a.sent();
                                            Utils_1.Utils.$message.error(e_4.message || e_4);
                                            return [3 /*break*/, 3];
                    ...
                    case 3: return [4 /*yield*/, remoteMethod(lodash_1.toString(keyWord))
    ...
    ItemConfig.prototype.optionsMatcher = function (r, values, callback) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.getOptionsSafe()];
                    case 1:
                        options = _d.sent();
                        try {
                            for (_b = __values(values.split(',')), _c = _b.next(); !_c.done; _c = _b.next()) {
                                value = _c.value;
    ...
    ItemConfig.prototype.getOptionsSafe = function () {
        ...
        if (this.type === 'search' && (this.options.length === 0 || !this.optionsInited)) {
            return this.remoteOptions || new Promise(function (r) {
                console.log('safe start', _this.label, _this.remoteOptions, _this.options);
                var b = mobx_1.reaction(function () { return _this.remoteOptions; }, function (options) {
                    r(options);
                    console.log('safe end', _this.label, options);
    ...
    ItemConfig.getDefaultRules = function (itemConfig, configStore) {
        return {
            phone: [{
                    validator: function (rule, value, callback) {
                        // value = Utils.isNotEmptyValueFilter(value, this.form[this.code])
                    ...
                    validator: function (rule, value, callback) {
                        ...
                        if (Utils_1.Utils.isNotEmptyString(value)) {
                            if (lodash_1.trim(value) === '*' || value.indexOf('新车') > -1 || (itemConfig.code !== 'licanseNo' && value === '车外')) {
                                ...
                                var selected = Utils_1.Utils.getOptionsByValue(configStore.licenseTypeList, form.licenseType);
