 ...
 * @param single
 */
export declare function getOptionsByLabel<T = Option, K = string>(optionList: T[], searchName: SearchKey<K>, single?: boolean): T | T[] | undefined;
/**
 ...
 * @param single
 */
export declare function getOptionsByValue<T = Option, K = string>(optionList: T[], searchValue: SearchKey<K>, single?: boolean): T | T[] | undefined;
/**
 ...
 * @param valueKey
 */
export declare function getCodeListByKey(codeType: Option[] | string, valueLabel?: boolean, valueKey?: boolean): RemoteSearcher;
/**
 *
 * @param optionList
 * @param label
 ...
 * @param joinKey
 */
export declare function valuesToLabels(options: Option[], value: SearchKey<string>, joinKey: string): string | string[];
/**
 * 批量转换label到value
 * @param options
 * @param label
 * @param joinKey
 */
export declare function labelsToValues(options: Option[], label: SearchKey<string>, joinKey: string): string | string[];
export declare function getCodeListByTranslate(codeType: any, valueLabel?: boolean, valueKey?: boolean): (codeCode: string) => Promise<Option[]>;
declare const _default: {
    getCodeListByKey: typeof getCodeListByKey;
    getCodeListByTranslate: typeof getCodeListByTranslate;
