...
var CommonDto = /** @class */ (function () {
    ...
    function CommonDto(dto) {
         ...
         */
        this.hasComputed = function (keyName) {
            return !Utils.isNil(Reflect.getOwnPropertyDescriptor(_this, '_' + keyName));
        };
        ...
        var _loop_1 = function (key) {
            var _a, _b;
            var keyName = _.camelCase("set-" + key);
    ...
    CommonDto.prototype.createComputed = function (keyName) {
        var _a;
        return extendObservable(this, (_a = {},
    ...
    CommonDto.prototype.getAndCreateDeepPropertyByStr = function (keyStr, defaultValue) {
        ...
        if (!Utils.isEmptyValue(keyStr)) {
            var express = Utils.getExpressByStr(keyStr, defaultValue);
            // console.log(this.$$___source_dto, keyStr, express, Reflect.apply(Utils.getInnerWarpField, this, [this.$$___source_dto, ...express]))
            return Utils.getPropertyFieldByCreate.apply(Utils, __spread([this.$$___source_dto], express));
    ...
    CommonDto.prototype.getPropertyByStr = function (keyName, defaultValue) {
        var value = property(keyName)(this.$$___source_dto);
    ...
    CommonDto.prototype.setPropertyByStr = function (keyName, value) {
        ...
        var str = "dto." + keyName + " = " + (Utils.isEmptyValue(value) ? "undefined" : (!Utils.isString(value) ? JSON.stringify(value) : "\"" + value + "\"") + ";");
        try {
            eval(str);
            return true;
        }
