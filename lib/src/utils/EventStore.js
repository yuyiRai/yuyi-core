...
var EventStore = /** @class */ (function (_super) {
    ...
    EventStore.prototype.$emit = function (eventName) {
        ...
        console.log.apply(console, ['log $emit', this.eventNames.includes(eventName), eventName].concat(args));
     ...
     */
    EventStore.prototype.$on = function (eventName, callback) {
        if (this.eventNames.includes(eventName)) {
            this.pipe(filter(function (_a) {
                var type = _a.type;
                return type === eventName;
            })).subscribe(function (e) { return callback.apply(void 0, e.args.concat([e])); });
            return true;
        }
        return false;
    };
