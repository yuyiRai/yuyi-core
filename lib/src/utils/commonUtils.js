...
var _ = {
    filter: filter, map: map, forEach: forEach
};
if (!Object.keys) {
    Object.keys = keys;
}
...
export default {
    ...
    castComputed: function (functionOrValue) {
        ...
        return isFunction(functionOrValue) ? functionOrValue.apply(void 0, computedArgs) : functionOrValue;
    },
    ...
    argShifter: function (todoFunc, startIndex) {
        ...
        return function () {
            ...
            return todoFunc.apply(void 0, takeRight(args, args.length - startIndex));
        };
    },
    ...
    test: function (length, pi) {
        if (pi === void 0) { pi = 8; }
        var test = Utils.getTestArray(length);
        var test2 = function (item, index) { return item > length / 2; };
        var test3 = function (item, index) { return Utils.arrayMapDive(test, test2); };
        setTimeout(function () {
        ...
        setTimeout(function () {
            ...
            var r8 = [];
            Utils.arrayForEachDive(test, function (item, index) {
        ...
        setTimeout(function () {
            ...
            var r8 = [];
            _.forEach(test, function (item, index) {
                r8.push(test3(item, index));
            });
