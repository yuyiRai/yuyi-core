    ...
    Object.defineProperty(AsyncLoadProperty.prototype, "valueGetter", {
        get: function () {
            ...
            if (this.timeBuffer > 0) {
                var emitter_1 = Utils_1.Utils.createSimpleTimeBufferInput(function (resList) {
                    _this.updateValue(_this.getterFunc(_.last(resList)));
                }, this, this.timeBuffer, true);
                return mobx_1.action(function (param) {
            ...
            descriptor.get = function () {
                ...
                if (!this[asyncName]) {
                    ...
                    mobx_1.extendObservable(this, (_a = {},
                        ...
                        _a));
                    if (!_.isNil(watcher)) {
                        mobx_1.reaction(function () { return _this[watcher]; }, function (trigger) {
...
var OptionsPipeStore = /** @class */ (function () {
    function OptionsPipeStore() {
        ...
        this.valuesToLabels = function (value, joinKey) {
            ...
            var result = Utils_1.Utils.isArrayFilter(Utils_1.Utils.arrayMapToKeysDive(Utils_1.Utils.getOptionsByValue(Utils_1.Utils.isArrayFilter(_this.isSearch ? _this.selectedOptions : _this.itemConfig.options), value), 'label'), []);
    ...
    OptionsPipeStore.prototype.patchSelectedOptionByValues = function (valueList, options) {
        var _this = this;
        this.selectedOptions = _.concat(this.selectedOptions, _.filter(Utils_1.Utils.getOptionsByValue(options, valueList), function (item) { return !_.some(_this.selectedOptions, function (option) { return option.value === item.value; }); }));
    };
    OptionsPipeStore.prototype.nextOptionsWillUpdateValue = function (nextOptions, keyWordArr, lastValue) {
        var selectedOptions = Utils_1.Utils.getOptionsByLabel(nextOptions, keyWordArr);
    ...
    OptionsPipeStore.prototype.labelsToValues = function () {
        ...
        return function (label) {
            return Utils_1.Utils.arrayMapToKeysDive(Utils_1.Utils.getOptionsByLabel(_this.isSearch ? _this.selectedOptions : _this.itemConfig.options, label), 'value');
        };
    };
    __decorate([
        mobx_1.observable,
