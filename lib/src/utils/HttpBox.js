...
var HttpBox = /** @class */ (function () {
    ...
    HttpBox.prototype.getRes = function (param) {
        var _this = this;
        var isObjectFilter = _1.default.isObjectFilter, createObjectKey = _1.default.createObjectKey;
    ...
    HttpBox.prototype.getReq = function (param, resolve, reject) {
        _1.default.simpleTimeBufferInput(param.__res_key, { param: param, resolve: resolve, reject: reject }, this.todo, 20);
    };
    ...
    HttpBox.prototype.todo = function (list) {
        var _this = this;
        var req = _1.default.last(list).param;
        this.service(req).then(function (res) {
            var e_1, _a;
            if (_this.whiteList.includes(req.url) && _this.useKey[req.url] == req.useKey) {
