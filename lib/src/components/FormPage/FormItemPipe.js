...
var CommonDto_1 = __importDefault(require("../../utils/CommonDto"));
var CommonFilter_1 = __importDefault(require("./input-Item/CommonFilter"));
...
var FormItemPipe = /** @class */ (function () {
    function FormItemPipe() {
         ...
         */
        this.itemConfig = {};
        mobx_1.reaction(function () { return _this.itemConfig.computed; }, function (computedValue) {
            _this.onDisabledChange();
            return computedValue !== false && _this.onComputedChange(computedValue);
        }, { name: 'onComputedValue' });
        mobx_1.reaction(function () { return _this.itemConfig.disabled; }, this.onDisabledChange, { name: 'onDisabledValue' });
        mobx_1.reaction(function () { return _this.itemConfig.hidden; }, this.onHiddenChange, { name: 'onHiddenValue' });
    }
    ...
    FormItemPipe.prototype.setItemConfig = function (itemConfig) {
        ...
        if (this.itemConfig !== itemConfig) {
            if (itemConfig instanceof stores_1.ItemConfig)
                this.itemConfig = itemConfig;
            else {
    ...
    FormItemPipe.prototype.createObservable = function (callback, callback2) {
        ...
        }), operators_1.tap(this.loadingStart), operators_1.debounceTime(20), operators_1.takeUntil(this.$destory)), rxjs_1.of({ code: this.itemConfig.code, isInit: true, changeType: 'init', changeSource: 'self' })).pipe(operators_1.distinctUntilChanged(function (pre, next) {
        ...
        operators_1.tap(function (form) { return _this.setForm(form); }), operators_1.map(this.getFormInitValueResponse), operators_1.map(util.setChangeSource('form')), operators_1.takeUntil(this.$destory)), // 初始值
        ...
        }), operators_1.takeUntil(this.$destory)).subscribe(function (res) {
    ...
    FormItemPipe.prototype.setValueToFormDto = function (value, key, safe) {
        ...
        if (dto instanceof CommonDto_1.default) {
