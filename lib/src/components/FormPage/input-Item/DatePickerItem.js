...
exports.default = mobx_vue_1.observer(vue_1.default.component('DatePickerItem', {
    ...
    render(h) {
        ...
        if (type === 'date' || type === 'dateTime') {
            ...
            // <!-- 日期 -->
            return (React.createElement("elDatePicker", Object.assign({ type: type.toLowerCase() }, commonProps, { defaultValue: new Date(), placeholder: placeholder })));
        }
        else if (type === "dateToDate") {
            // <!-- 日期范围 -->
            const { startPlaceholder, endPlaceholder, time } = itemConfig;
            return (React.createElement("elDatePicker", Object.assign({ type: 'daterange' }, commonProps, { unlinkPanels: true, startPlaceholder: startPlaceholder || "起始时间", endPlaceholder: endPlaceholder || "截止时间", pickerOptions: pickerOptions })));
        }
        else {
            return null;
        }
