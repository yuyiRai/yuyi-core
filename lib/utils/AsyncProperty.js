        ...
        get: function () {
            ...
            if (this.timeBuffer > 0) {
                var emitter_1 = Utils_1.Utils.createSimpleTimeBufferInput(function (resList) {
                    _this.updateValue(_this.getterFunc(lodash_1.last(resList)));
    ...
    function Async(target, propertyName, descriptor) {
        ...
        if (getter) {
            descriptor.get = function () {
                ...
                console.log('getter', this, mobx_1.isComputed(this));
                if (!this[asyncPropertyMapKey]) {
                    var map_1 = new Map();
                    mobx_1.extendObservable(this, (_a = {}, Object.defineProperty(_a, asyncPropertyMapKey, {
                ...
                if (!this[asyncName]) {
                    ...
                    mobx_1.extendObservable(this, (_b = {}, Object.defineProperty(_b, asyncName, {
                    ...
                    if (!Utils_1.Utils.isNil(watcher)) {
                        ...
                        mobx_1.reaction(function () { return _this[propertyName]; }, function (property) {
                ...
                if (currentValue === defaultValue) {
                    ...
                    return createInstance(Utils_1.Utils.cloneDeep(currentValue), asyncName, asyncConfig);
                }
                else {
        ...
        return mobx_1.computed(target, propertyName, descriptor);
    }
    return Async;
}
...
var AsyncPropertyGetter = /** @class */ (function () {
    ...
    AsyncPropertyGetter.prototype.get = function (t, key) {
        ...
        return mobx_1.getDebugName(t[key]);
    };
    __decorate([
        mobx_1.observable,
...
exports.AsyncPropertyGetter = AsyncPropertyGetter;
window.AsyncPropertyGetter = AsyncPropertyGetter;
window.getDebugName = mobx_1.getDebugName;
