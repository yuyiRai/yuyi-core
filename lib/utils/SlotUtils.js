    ...
    return {
        ...
        render: function (h, vueProps) {
            ...
            return h(ReactWrapper, {
                ...
                attrs: __assign({}, props, attrs, { $scopedSlots: scopedSlots || (vueProps != null && vueProps.data != null && vueProps.data.attrs != null && vueProps.data.attrs.scopedSlots != null ? vueProps.data.attrs.scopedSlots : undefined), $commonSlots: function () { return getSlotFromVNode(slots); } }),
                on: {
                    'onClick': console.log
                }
            }, children);
...
export function useSlots(target, propertyName) {
    ...
    Reflect.defineProperty(target, propertyName, {
        value: function (props) {
            var _a = React.useContext(SlotContext), slots = __rest(_a.slots, []), scopedSlots = __rest(_a.scopedSlots, []);
            var Renderer = slots[slotName] || scopedSlots[slotName] || value || (function () { return true ? React.createElement("span", null) : React.createElement("span", null,
                "slots-",
                slotName); });
            return React.createElement(Renderer, __assign({}, props));
        },
        writable: false
    });
