    ...
    return {
        ...
        render: function (h, vueProps) {
            ...
            return h(ReactWrapper, {
                ...
                attrs: __assign({}, props, attrs, { $scopedSlots: scopedSlots || attrs.scopedSlots, $commonSlots: function () { return getSlotFromVNode(slots); } }),
                on: {
                    'onClick': console.log
                }
            }, children);
...
export function slotInjectContainer(target) {
    ...
    var injected = function (nextProps) {
        ...
        // debugger
        return (React.createElement(SlotContext.Provider, { value: injectProps },
...
export function useSlots(target, propertyName) {
    ...
    Object.defineProperty(target, propertyName, {
        get: function () {
            ...
            return slots[slotName] || scopedSlots[slotName] || value || (function () { return true ? null : React.createElement("span", null,
                "slots-",
                slotName); });
        }
    });
