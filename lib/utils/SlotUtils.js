...
export var Slot = React.memo(function (_a) {
    ...
    var _b = React.useContext(SlotContext), slots = __rest(_b.slots, []), scopedSlots = __rest(_b.scopedSlots, []);
...
export var ScopedSlot = function (_a) {
    ...
    var Renderer = slotComponent || (function () { return true ? React.createElement("span", null) : React.createElement("span", null,
        "slots-",
        slotName); });
    return React.createElement("span", null, Renderer(other));
};
