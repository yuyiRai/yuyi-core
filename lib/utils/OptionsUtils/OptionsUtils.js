 ...
 * @param valueKey
 */
export function getCodeListByKey(codeType, optionFactory) {
    // debugger
    var isArrayFilter = typeFilterUtils.isArrayFilter;
    if (isArray(codeType)) {
        return function (keyWord, isOnlySearch) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, castArray(getOptionsByKey(codeType, new RegExp(Utils.escapeRegExp(keyWord))))];
                });
            });
        };
    }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = isArrayFilter;
                            return [4 /*yield*/, codeType(keyWord, isOnlySearch)];
                        case 1:
                            res = _a.apply(void 0, [_b.sent()]) || [];
                            return [2 /*return*/, optionFactory ? map(res, optionFactory) : res];
                    }
                });
            });
        };
...
export function convertValueOption(valueList, isFull) {
    if (isFull === void 0) { isFull = false; }
    return map(valueList, function (value) { return Object.assign({ value: value }, isFull ? { label: value } : {}); });
}
export default {
    ...
    convertValueOption: convertValueOption
};
