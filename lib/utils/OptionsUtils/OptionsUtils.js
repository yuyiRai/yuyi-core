...
function getCodeListByKey(codeType, optionFactory) {
    debugger;
    var isArrayFilter = TypeLib_1.typeFilterUtils.isArrayFilter;
        ...
        return function (keyWord, isOnlySearch) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, lodash_1.castArray(getOptionsByKey(codeType, new RegExp(Utils_1.Utils.escapeRegExp(keyWord))))];
                });
            });
        };
    }
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, optionFactory ? lodash_1.map(res, optionFactory) : res];
                    }
                });
            });
        };
