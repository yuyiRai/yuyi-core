// import { JSONDecoder, JSONEncoder } from "assemblyscript-json";
// import { JSONHandler } from "assemblyscript-json/assembly/decoder";

export class Item {
  a: i32;
}

export function forEach<T = Item>(list: Array<T>, when: (value: T, index: i32, array: Array<T>) => void): void {
  list.forEach(when)
}
