...
export declare type FormItemTypeKeys = keyof FormItemTypeDescription;
export declare type FormItemType = "" | FormItemTypeKeys | undefined | null | never;
/**
 * 表单model
 */
export declare type FormModel<M extends IKeyValueMap = IKeyValueMap> = M;
 ...
 * 将类型成员变成计算属性
 */
export declare type WithComputedPick<T, FM> = {
 ...
 * @inheritDoc
 */
export interface IFormItemConstructor<FM = any, VALUE = any, CVALUE = VALUE> extends IItemConfigStatic<FM, VALUE, CVALUE>, IItemConfigCreaterStatic<FM, VALUE>, ISearchConfigBase<FM>, ConstructorPick<ISearchConfigCreater<VALUE, FM>>, ConstructorPick<IDisplayConfigCreater<FM>>, ConstructorPick<IRuleStoreCreater<VALUE, FM>> {
    children?: IKeyValueMap<IFormItemConstructor<FM, VALUE, CVALUE>> | false;
    [key: string]: any;
}
export interface IItemConfig<FM = FormModel, VALUE = any, CVALUE = VALUE> extends IItemConfigStatic<FM, VALUE, CVALUE>, ComputedPick<IItemConfigCreater<FM, VALUE>, FM>, ISearchConfig<VALUE, FM>, IDisplayConfig<FM>, IRuleStore<VALUE, FM>, CommonStore {
