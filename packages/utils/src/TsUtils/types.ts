 ...
 */
export type IsEmptyObj<T = unknown, TRUE = true, FALSE = false> = IsTargetTyped<{ [key: string]: never }, T, TRUE, FALSE>
export type IsEmptyArr<T = unknown, TRUE = true, FALSE = false> = IsTargetTyped<[], T, TRUE, FALSE>
export type IsAny<T = unknown, TRUE = true, FALSE = false> = IsEmptyObj<T, FALSE, IsTargetTypedRe<unknown, T, TRUE, FALSE>>
export type IsUnknown<T = unknown, TRUE = true, FALSE = false> = IsTargetTypedRe<unknown, T, TRUE, FALSE>
export type IsArray<T = unknown, TRUE = true, FALSE = false> = IsUnknown<T, FALSE, T extends Array<any> ? TRUE : FALSE>
...
export type IsClasses<T = unknown, TRUE = true, FALSE = false> = IsObject<T, IsEmptyObj<T, FALSE, IsBaseType<T, FALSE, T extends InstanceType<any> ? TRUE : FALSE>>, FALSE>
