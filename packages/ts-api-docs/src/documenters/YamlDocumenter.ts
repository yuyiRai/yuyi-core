...
import { ApiItemKind, ExcerptTokenKind, NewlineKind } from './type';
...
export class YamlDocumenter {
  ...
  protected _shouldEmbed(apiItemKind: any): boolean {
    switch (apiItemKind) {
  ...
  protected _shouldInclude(apiItemKind: any): boolean {
