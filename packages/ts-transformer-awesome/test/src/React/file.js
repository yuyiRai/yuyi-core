...
//   }))
// }
var Hr = MACRO(function (children) { return React.createElement("h1", { className: "h1" }, children); });
...
return (Array.from(([1, 2, 3]), function (item, itemIndex) { return [React.createElement(Hr, null, item),
